          ...
          <nav className="py-3 px-2">
            ...
            <div className="mt-4 pt-3 border-t border-gray-200">
              ...
              {pmExpanded && <div className="space-y-0.5">
                ...
                <button className={`w-full flex items-center gap-2.5 px-3 py-1.5 rounded-lg text-[13px] transition-all ${isActive('/crm/finance/statements') ? 'bg-[#791E75] text-white shadow-sm' : 'text-gray-600 hover:bg-gray-100 hover:text-gray-900'}`} onClick={() => setLocation('/crm/finance/statements')}>
                  <FileSpreadsheet className={`h-3.5 w-3.5 flex-shrink-0 ${isActive('/crm/finance/statements') ? 'text-white' : 'text-gray-400'}`} />
                  Pending Statements
                </button>
                <button className={`w-full flex items-center gap-2.5 px-3 py-1.5 rounded-lg text-[13px] transition-all ${isActive('/crm/finance/invoices') ? 'bg-[#791E75] text-white shadow-sm' : 'text-gray-600 hover:bg-gray-100 hover:text-gray-900'}`} onClick={() => setLocation('/crm/finance/invoices')}>
                  <Receipt className={`h-3.5 w-3.5 flex-shrink-0 ${isActive('/crm/finance/invoices') ? 'text-white' : 'text-gray-400'}`} />
                  Tenant Invoices (Agent)
                </button>
                ...
                <button className={`w-full flex items-center gap-2.5 px-3 py-1.5 rounded-lg text-[13px] transition-all ${isActive('/crm/compliance/unmanaged') ? 'bg-[#791E75] text-white shadow-sm' : 'text-gray-600 hover:bg-gray-100 hover:text-gray-900'}`} onClick={() => setLocation('/crm/compliance/unmanaged')}>
                  <AlertTriangle className={`h-3.5 w-3.5 flex-shrink-0 ${isActive('/crm/compliance/unmanaged') ? 'text-white' : 'text-gray-400'}`} />
            ...
            <div className="mt-4 pt-3 border-t border-gray-200">
              ...
              <div className="space-y-0.5">
                ...
                <button className={`w-full flex items-center gap-2.5 px-3 py-1.5 rounded-lg text-[13px] transition-all ${isActive('/crm/report-center') ? 'bg-[#791E75] text-white shadow-sm' : 'text-gray-600 hover:bg-gray-100 hover:text-gray-900'}`} onClick={() => setLocation('/crm/report-center')}>
                  <BarChart3 className={`h-3.5 w-3.5 flex-shrink-0 ${isActive('/crm/report-center') ? 'text-white' : 'text-gray-400'}`} />
                  Report Center
                </button>
              </div>
              </>}

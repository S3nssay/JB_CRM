...
- **Global scope**: `C:/Users/ziaa/Dropbox/ZA/DEV/PROJECTS/JB_CRM/.claude/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `C:/Users/ziaa/Dropbox/ZA/DEV/PROJECTS/JB_CRM/.claude/notes/`)
...
2. Glob `C:/Users/ziaa/Dropbox/ZA/DEV/PROJECTS/JB_CRM/.claude/notes/*.md` (if directory exists) — global notes
...
Global (C:/Users/ziaa/Dropbox/ZA/DEV/PROJECTS/JB_CRM/.claude/notes/):
...
2. **No `.planning/`**: Falls back to global `C:/Users/ziaa/Dropbox/ZA/DEV/PROJECTS/JB_CRM/.claude/notes/` — works in any directory

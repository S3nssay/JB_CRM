...
const DEFAULT_GLOW_COLOR = '212, 160, 79';
...
export const ParticleCard = ({
  ...
  useEffect(() => {
    ...
    element.addEventListener('mouseenter', handleMouseEnterInternal);
    element.addEventListener('mouseleave', handleMouseLeaveInternal);
    element.addEventListener('mousemove', handleMouseMove);
    element.addEventListener('click', handleClick);

    return () => {
      isHoveredRef.current = false;
      element.removeEventListener('mouseenter', handleMouseEnterInternal);
      element.removeEventListener('mouseleave', handleMouseLeaveInternal);
